...
namespace LimaDefender
{
	...
	private:
		...
		Bitmap^ background = gcnew Bitmap("../Contents/Nivel1_background.png");
		Keys tecla;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &FormNivel1::timer1_Tick);
			// 
			// timer2
			// 
			this->timer2->Enabled = true;
			this->timer2->Interval = 20000;
			this->timer2->Tick += gcnew System::EventHandler(this, &FormNivel1::timer2_Tick);
			// 
			// FormNivel1
			// 
			...
			this->Load += gcnew System::EventHandler(this, &FormNivel1::FormNivel1_Load);
...
#pragma endregion
	private: System::Void FormNivel1_Load(System::Object^ sender, System::EventArgs^ e)
	{
		musica->SoundLocation = "../Contents/Nivel1_music.wav";
		musica->Load();
		musica->Play();
	}
	...
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e)
	{
		...
		{
			musica->Stop(); //La musica no se detiene
			victoria = false;
